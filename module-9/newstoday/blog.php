...
<body>
    ...
    <div id="wrapper">
        ...
        <h1 class="py-5 mt-5 text-center">Blog Posts</h1>
                                ...
                                <nav aria-label="Page navigation">
                                    <ul class="pagination justify-content-center">
                                        ...
                                        ?>
                                            ...
                                            <li class="page-item">
                                                <a class="page-link" href="blog.php?page=<?php echo ($page - 1) ?>">prev</a>
                                            </li>
                                        ...
                                        ?><li class="page-item">
                                                <a class="page-link" href="blog.php?page=<?php echo $i ?>" <?php if ($i == $page)
                                                                                                            { ?> style="background-color: #f7db7e !important;" <?php } ?>>
                                                    <?php echo $i ?>
                                                </a>
                                            </li>
                                        <?php
